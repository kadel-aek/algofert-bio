...
export default function Hero({ heroVideo, fullFilm }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#06170e]/95 via-[#0a2b1a]/82 to-[#0a2b1a]/44" />
      ...
      {/* Contenu principal */}
      <div className="relative z-10 mx-auto grid w-full max-w-[1600px] items-center gap-12 xl:grid-cols-[0.82fr_1.18fr] xl:gap-10">
        {/* Colonne de gauche */}
        <div className="min-w-0">
          <div data-hero-eyebrow>
            <span className="inline-flex max-w-full rounded-full border border-[#e3bd42]/30 bg-[#e3bd42]/10 px-4 py-2 text-[10px] font-bold uppercase leading-5 tracking-[0.22em] text-[#f0d36f] backdrop-blur-md sm:text-xs sm:tracking-[0.28em]">
              Innovation agricole algérienne
            </span>
          </div>
          ...
          <h1 className="mt-7 max-w-5xl text-[2.75rem] font-extrabold leading-[0.98] tracking-[-0.045em] sm:mt-8 sm:text-6xl sm:leading-[0.94] sm:tracking-[-0.055em] lg:text-[5.6rem]">
            ...
            <span
              data-hero-title-line
              className="mt-2 block origin-bottom bg-gradient-to-r from-[#f3d66f] via-[#e3bd42] to-[#9ddf77] bg-clip-text text-transparent"
            >
          ...
          >
            Une gamme de biofertilisants microbiens fondée sur des consortiums
            de bactéries PGPR autochtones algériennes, développée pour
            accompagner durablement la croissance et les performances des
            cultures.
          </p>

          <p
            data-hero-signature
            className="mt-5 max-w-2xl border-l-2 border-[#e3bd42]/70 pl-4 text-sm font-semibold leading-6 text-white/65 sm:pl-5 sm:leading-7"
          >
        ...
        {/* Illustration scientifique — masquée sur mobile */}
        <div
          data-hero-graphic
      ...
      {/* Indicateur de défilement — masqué sur téléphone */}
      <a
        data-scroll-indicator
        href="#technologie"
